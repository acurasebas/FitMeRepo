...
public class LoginActivity extends SherlockActivity implements ActionBar.OnNavigationListener{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<CharSequence> list = ArrayAdapter.createFromResource(context, R.array.menuPrueba, R.layout.sherlock_spinner_item);
